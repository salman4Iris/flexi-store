...
const CheckoutPage = (): React.ReactElement => {
	...
	return (
		<>
			<Container>
				<Section>
					<div className="max-w-6xl mx-auto pb-32 lg:pb-0">
						<h1 className="text-xl sm:text-2xl font-bold mb-6 lg:mb-8">Checkout</h1>
						...
						<div className="grid grid-cols-1 lg:grid-cols-3 gap-6 lg:gap-8 items-start">
										...
										<div className="grid grid-cols-2 sm:grid-cols-3 gap-3 sm:gap-4">
											...
											<FormField label="State" id="state" error={formErrors.state}>
												<select
													...
													value={form.state}
													onChange={handleChange}
													className="flex h-10 w-full rounded-md border border-input bg-background px-3 py-2 text-base text-foreground outline-none transition-colors focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:opacity-50"
												>
							...
							<Card>
								...
								<CardContent className="space-y-3">
									{/* Cash on Delivery */}
									<label
										className={`flex items-start gap-3 rounded-lg border p-3 sm:p-4 cursor-pointer transition-all ${
											paymentMethod === 'cod'
		...
		<div className="fixed bottom-0 left-0 right-0 lg:hidden bg-background border-t border-border shadow-lg z-40">
			<div className="max-w-2xl mx-auto px-4 py-2">
				{error && (
					<p className="text-xs text-destructive bg-destructive/10 rounded px-2 py-1.5 mb-2 border border-destructive/30 font-medium">
						{error}
					</p>
				)}
				...
				<div className="flex items-center justify-between gap-3">
					<div className="min-w-0">
						...
						<p className="text-base sm:text-lg font-bold text-primary">₹{orderTotal.toLocaleString('en-IN')}</p>
					</div>
